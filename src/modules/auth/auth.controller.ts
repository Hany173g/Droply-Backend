...
import {
    Register,
    verifyAccount,
    twoFactorAuthenticationFlow,
    refresh as refreshSevice,
    forgetPassword as forgetPasswordService,
    login as loginService,
    updatePassword as updatePasswordService,
    verifyForgetPasswordToken as verifyForgetPasswordTokenService,
...
export const login = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    let responseSchema = {}
    let loginData = await loginService(
        email,
        password,
...
export const twoFactorAuthenticationVerification = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
        ...
        const { accessToken, refreshToken } = await twoFactorAuthenticationFlow(
            token,
            verificationId,
            req.headers["user-agent"] || "unknown",
            req.ip || "unknown",
